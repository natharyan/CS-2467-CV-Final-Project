...
// MatrixXd computeFundamentalMatrixOLD(const std::vector<std::pair<Eigen::Vector2d, Eigen::Vector2d>>& matches) {
...
// MatrixXd ransacFundamentalMatrixOLD(const std::vector<std::pair<Eigen::Vector2d, Eigen::Vector2d>>& matches, int maxIterations, double threshold) {
...
//         MatrixXd F = computeFundamentalMatrixOLD(sample);
