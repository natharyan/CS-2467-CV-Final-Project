...
int main(){
    ...
    cv::Mat img1 = cv::imread("dataset/water_canon/5.jpg", cv::IMREAD_GRAYSCALE);
    cv::Mat img2 = cv::imread("dataset/water_canon/8.jpg", cv::IMREAD_GRAYSCALE);
    ...
    plotEpipolarLinesAndInliers(img1, img1, points1, points2, fundamental_matrix, inliers_mask);
